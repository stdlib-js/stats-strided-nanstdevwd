...
```javascript
nanstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanstdevwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-nanstdevwd/tags). For example,

```javascript
nanstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanstdevwd@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var nanstdevwd = require( 'path/to/vendor/umd/stats-strided-nanstdevwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanstdevwd@umd/browser.js"></script>
```
...
Computes the [standard deviation][standard-deviation] of a strided array ignoring `NaN` values and using Welford's algorithm.
...
var v = nanstdevwd( 5, 1, x1, 2 );
// returns 2.5
```

#### nanstdevwd.ndarray( N, correction, x, strideX, offsetX )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-nanstdevwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-nanstdevwd

[test-image]: https://github.com/stdlib-js/stats-strided-nanstdevwd/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-nanstdevwd/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-nanstdevwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-nanstdevwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-nanstdevwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-nanstdevwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-nanstdevwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-nanstdevwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-nanstdevwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-nanstdevwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-nanstdevwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-nanstdevwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-nanstdevwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-nanstdevwd/main/LICENSE
